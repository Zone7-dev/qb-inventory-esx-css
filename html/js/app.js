        ...
        if (ItemData.name !== undefined) {
            if ((ItemData.name).split("_")[0] == "weapon") {
                if (!$("#weapon-attachments").length) {
                    ...
                    $(".inv-options-list").append('<div class="inv-option-item" id="weapon-attachments"><p>EKLENTİLER</p></div>');
    ...
    $.post("http://qb_inventory/GetWeaponData", JSON.stringify({
        ...
        if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
            if (data.AttachmentData.length > 0) {
                $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">EKLENTİLER</span>');
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html('<p><strong>BSN: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Ad: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Soyad: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Dogum T.: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Cinsiyet: </strong><span>' + gender + '</span></p><p><strong>Memleket: </strong><span>' + itemData.info.nationality + '</span></p>');
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Ev Numaran NO :</strong><span>' + itemData.info.house + '</span></p>');
        } else if (itemData.name == "vehiclekeys") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>Plaka: ' + itemData.info.plate + '</p>');
    } else if (itemData.name == "sparekeys") {
             $(".item-info-title").html('<p>'+itemData.label+'</p>')
             $(".item-info-description").html('<p>Plaka: ' + itemData.info.plate + '</p>');
        } else if (itemData.name == "carkey") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Arac Plakasi :</strong><span>' + itemData.info.datacheck + '</span></p>');
        } else if (itemData.name == "motelkey") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong></strong><span>' + itemData.info.motelId + '</span></p>');
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html('<p><strong>Seri Numarası: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Cephane: </strong><span>' + itemData.info.ammo + '</span></p><p><strong>EKLENTİLER: </strong><span>' + attachmentString + '</span></p>');
            } else{
    ...
    $(".item-drag").draggable({
        ...
        start: function(event, ui) {
           ...
           // $(this).css("background", "rgba(20,20,20,1.0)");
            ...
            $(".item-slot").css("border", "0px solid rgba(255, 255, 255, 0.1)")
...
(() => {
    ...
    Inventory.Close = function() {
        $(".item-slot").css("border", "0 px solid rgba(255, 255, 255, 0.1)");
